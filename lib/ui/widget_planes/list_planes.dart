                          ...
                          return GestureDetector(
                            onTap: () {
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                    builder: (context) =>
                                        DetailPlanPage(planesData: plan)),
                              );
                            },
                            child: Card(
                                  ...
                                  Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        SizedBox(height: 4),
                                        // Precio anterior
                                        if (plan.precio_normal != null)
                                          Text(
                                            'Antes: S/${plan.precio_normal!.toStringAsFixed(2)}',
                                            style: TextStyle(
                                                fontSize: 13,
                                                color: Colors.grey,
                                                decoration:
                                        ...
                                        Row(
                                          children: [
                                            Text(
                                              'S/${plan.precio_plan!.toStringAsFixed(2) ?? 0}',
                                              style: TextStyle(
                                                fontSize: 16,
                                                fontWeight: FontWeight.bold,
                                                color: Colors.black,
                                            ...
                                            Container(
                                              ...
                                              child: Text(
                                                '-${(double.tryParse(plan.porcentaje?.toString() ?? '0') ?? 0).toStringAsFixed(0)}%',
                                                style: TextStyle(
                                                  color: Colors.white,
                                                  fontSize: 16,
                                                ),
