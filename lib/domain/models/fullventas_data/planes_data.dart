...
List<PlanesData> planesDataFromJson(String str) {
  final jsonData = json.decode(str) as List;
  return jsonData.map((item) => PlanesData.fromJson(item)).toList();
}

String planesDataToJson(PlanesData? data) => json.encode(data!.toJson());
...
class PlanesData {
  ...
  factory PlanesData.fromJson(Map<String, dynamic> json) => PlanesData(
        ...
        precio_plan: double.tryParse(json['precio_plan'].toString()) ?? 0.0,
